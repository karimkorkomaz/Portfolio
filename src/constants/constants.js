...
const projects = [
  {
    ...
    description:
      "A landing page for a company named Smart Tech Solutions.",
    features: [
      "Users can create a send a contact form",
   ,
    ],
    tags: [
      {
    ...
    live_link: "https://www.sts-lb.net/",
  },
  {
    name: "Nike-clone website",
    description:
      "A dynamic full-stack E-commerce Website .",
    features: [
      "User authentication using NextAuth.js with JWT and OAuth providers.",
      "Users can Add,update,delete items to and from cart",
      "Users can search for any product",
      "Users can filter products",
      "Admin has a full functional admin dashboard to edit products, view messages and view orders made by the users"
    ],
    tags: [
      {
        name: "react",
    ...
    image: carrent,
    source_code_link: "https://github.com/karimkorkomaz/nike-clone.git",
    live_link: "https://nike-clone-beta-weld.vercel.app/",
  },
  /* {
    name: "Study Notion",
